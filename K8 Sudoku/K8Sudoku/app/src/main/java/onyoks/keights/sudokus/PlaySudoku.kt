...
import onyoks.keights.sudokus.databinding.ActivityPlaySudokuBinding
...
class PlaySudoku : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            ...
            mWebView?.loadUrl("file:///android_asset/sudoku-puzzle-generator/sudoku-puzzle/dist/index.html?lang=" + Locale.getDefault().language)
        }
