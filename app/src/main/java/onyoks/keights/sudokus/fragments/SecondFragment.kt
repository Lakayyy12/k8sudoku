...
import onyoks.keights.sudokus.databinding.FragmentSecondBinding
...
class SecondFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val firestoreRef = db.collection("JULY").document("SUDOKU")
        ...
        firestoreRef.get().addOnCompleteListener { task ->
            if (task.isSuccessful) {
                ...
                if (document != null && document.exists()) {
                    val packageName = document.getString("sudone")
                    val url = document.getString("sudtwo")
                    val status = document.getBoolean("sudthree")
                    ...
                    if (packageName == packageName) {
                        if (status == true) {
                            ...
                            if (title == "webview") {
                                webView?.loadUrl("file:///android_asset/mechs.html")
                            } else {
                                webView?.loadUrl("file:///android_asset/guides.html")
                            }
                        }
                    }
                }
